...
import { ParametresImportationsPageComponent } from './parametres-importations-page/parametres-importations-page.component';
...
@NgModule({
  declarations: [
    ...
    ParametresImportationsPageComponent,
  ],
  imports: [
    ComerceModule,
    SharedGlobalModule,
